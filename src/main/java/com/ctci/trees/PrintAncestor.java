...
// Given a binary tree's root node, an empty ArrayList
// and an integer nodeData, write a method that finds
// a target node - N with data = nodeData and populates the ArrayList
// with the data of the ancestor nodes of N - added from the bottom - up.
// Example:
//    1
//   / \
//  2   3
...
public class PrintAncestor {
  ...
  public boolean printAncestors(TreeNode root, int nodeData) {
    ...
    if (nodeData == root.data) return true;
