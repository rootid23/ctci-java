 ...
 * solved earlier! Rotating an
 * image counterclockwise can be achieved by taking the transpose of the image
 * matrix and then flipping it
 ...
 *   1 1
 */
public class RotateSquareImageCCW {
